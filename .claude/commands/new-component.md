...
1. Determine the component name and target directory from $ARGUMENTS.
   - If a subfolder is given (e.g. `dataPage/MyComponent`), place the file at `client/components/<subfolder>/<ComponentName>.tsx`.
   - Otherwise place it at `client/components/<ComponentName>.tsx`.
