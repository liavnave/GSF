...
2. Create `server/app/routers/<name>.py` following this exact pattern:
   ```python
...
3. Register the router in `server/app/main.py`:
   ```python
...
4. Run `uv run ruff check server/` and fix any issues.
