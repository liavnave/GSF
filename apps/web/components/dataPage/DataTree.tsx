...
import type { Column, ColumnField, Database, Schema, Table } from '@/types/datasources';
...
function ColumnBlock({
	...
	const containsFocus = selectedId != null && columnSubtreeContainsFocus(column, selectedId);
	...
	return (
		<div>
			<Row
				...
				branchHref={
					hasChildren ? `${hrefPrefix}?focus=${encodeURIComponent(column.id)}` : undefined
				}
			/>
			{open && hasChildren ? (
				<FieldRows
